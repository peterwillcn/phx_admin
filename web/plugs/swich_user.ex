defmodule PhxAdmin.Plug.SwitchUser do
  @moduledoc """
  ...
  how to change this default:
      ...
      plug PhxAdmin.Plug.SwitchUser, current_user_name: :full_name
      plug PhxAdmin.Plug.SwitchUser, &MyProject.User.user_name/1
      plug PhxAdmin.Plug.SwitchUser, {MyProject.User, :user_name}
  ...
  def init(opts) do
    unless Application.get_env(:phx_admin, :login_user) && Application.get_env(:phx_admin, :logout_user) do
      raise """
        :login_user and :logout_user must be configured to use PhxAdmin.Plug.SwitchUser.
        Please configure these and recompile your project.
        """
    end
    %{
      current_user_id: opts[:current_user_id] || Application.get_env(:phx_admin, :current_user_id, :id),
      current_user_name: opts[:current_user_name] || Application.get_env(:phx_admin, :current_user_name, :name),
