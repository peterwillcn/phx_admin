defmodule PhxAdmin.Theme.AdminLte2.Layout do
  @moduledoc false
  ...
  def link_to_active(conn, name, path, id, opts \\ []) do
    ...
    icon = if path == PhxAdmin.Utils.admin_path(:page, [:dashboard]) do
  ...
  def theme_selector? do
    not is_nil(Application.get_env(:phx_admin, :theme_selector))
  end
  def theme_selector do
