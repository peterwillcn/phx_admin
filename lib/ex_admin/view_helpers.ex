defmodule PhxAdmin.ViewHelpers do
  @moduledoc false
  use Xain
  ...
  @endpoint Application.get_env(:phx_admin, :endpoint)
  ...
  def page_title(conn, resource) do
    ...
    case PhxAdmin.Utils.action_name(conn) do
      :index ->
        plural
      :show ->
        cond do
          ...
          true ->
            PhxAdmin.Helpers.resource_identity(resource)
        end
