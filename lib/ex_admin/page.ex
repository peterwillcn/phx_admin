defmodule PhxAdmin.Page do
  @moduledoc """
  Define pages in PhxAdmin that don't render models, like a dashboard
  page.
  ...
  defmacro __using__(_) do
    quote do
      import PhxAdmin.Form, except: [content: 1]
  ...
  defmacro columns(do: block) do
    quote do
      ...
      var!(columns, PhxAdmin.Page) = []
      unquote(block)
      cols = var!(columns, PhxAdmin.Page) |> Enum.reverse
      var!(columns, PhxAdmin.Page) = []
  ...
  defmacro column([do: block]) do
    quote do
      ...
      var!(columns, PhxAdmin.Page) = [html | var!(columns, PhxAdmin.Page)]
    end
  end
