defmodule TestExAdmin.CreateTest do
  ...
  setup do
    old_theme = Application.get_env(:phx_admin, :theme)
    on_exit fn ->
      Application.put_env(:phx_admin, :theme, old_theme)
    end
  ...
  for x <- [PhxAdmin.Theme.ActiveAdmin, PhxAdmin.Theme.AdminLte2] do
    Application.put_env :phx_admin, :theme, x
