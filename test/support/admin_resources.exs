defmodule TestExAdmin.PhxAdmin.Dashboard do
  ...
  register_page "Dashboard" do
    ...
    content do
      div ".blank_slate_container#dashboard_default_message" do
        span ".blank_slate" do
          span "Welcome to PhxAdmin. This is the default dashboard page."
...
defmodule TestExAdmin.PhxAdmin.Noid do
  use PhxAdmin.Register
...
defmodule TestExAdmin.PhxAdmin.User do
  use PhxAdmin.Register
...
defmodule TestExAdmin.PhxAdmin.Product do
  use PhxAdmin.Register
...
defmodule TestExAdmin.PhxAdmin.Simple do
  use PhxAdmin.Register
...
defmodule TestExAdmin.PhxAdmin.UUIDSchema do
  use PhxAdmin.Register
...
defmodule TestExAdmin.PhxAdmin.Noprimary do
  use PhxAdmin.Register
...
defmodule TestExAdmin.PhxAdmin.Contact do
  use PhxAdmin.Register
...
defmodule TestExAdmin.PhxAdmin.ModelDisplayName do
  use PhxAdmin.Register
  register_resource TestExAdmin.ModelDisplayName do
  end
end

defmodule TestExAdmin.PhxAdmin.DefnDisplayName do
  use PhxAdmin.Register
...
defmodule TestExAdmin.PhxAdmin.RestrictedEdit do
  use PhxAdmin.Register
