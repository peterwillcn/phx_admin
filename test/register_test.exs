defmodule TestExAdmin.PhxAdmin.Test do
...
defmodule TestExAdmin.PhxAdmin.Test2 do
  use PhxAdmin.Register
...
defmodule TestExAdmin.RegisterTest do
  ...
  alias PhxAdmin.Register


  setup do
    {:ok, defn: %TestExAdmin.PhxAdmin.Test{}, defn2: %TestExAdmin.PhxAdmin.Test2{}}
  end
