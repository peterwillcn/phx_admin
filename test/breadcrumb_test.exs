defmodule PhxAdmin.BreadCrumbTest do
  use ExUnit.Case, async: true
  alias PhxAdmin.BreadCrumb
  import Plug.Conn
  ...
  def simple_setup(_) do
    ...
    conn = assign(%Plug.Conn{}, :theme, PhxAdmin.Theme.AdminLte2)
    |> assign(:defn, defn)
  ...
  def model_display_name(_) do
    defn = %TestExAdmin.PhxAdmin.ModelDisplayName{}
    conn = assign(%Plug.Conn{}, :theme, PhxAdmin.Theme.AdminLte2)
    |> assign(:defn, defn)
  ...
  def defn_display_name(_) do
    defn = %TestExAdmin.PhxAdmin.DefnDisplayName{}
    conn = assign(%Plug.Conn{}, :theme, PhxAdmin.Theme.AdminLte2)
    |> assign(:defn, defn)
